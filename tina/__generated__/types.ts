...
export type PostsPartsFragment = { __typename: 'Posts', title: string, slug: string | null, author: string, pubDatetime: string, modDatetime: string | null, featured: boolean | null, draft: boolean | null, tags: Array<string | null> | null, description: string, ogImage: string | null, canonicalURL: string | null, hideEditPost: boolean | null, timezone: string | null, body: any };
...
export type PostsQuery = { posts: { __typename: 'Posts', id: string, title: string, slug: string | null, author: string, pubDatetime: string, modDatetime: string | null, featured: boolean | null, draft: boolean | null, tags: Array<string | null> | null, description: string, ogImage: string | null, canonicalURL: string | null, hideEditPost: boolean | null, timezone: string | null, body: any, _sys: { filename: string, basename: string, hasReferences: boolean | null, breadcrumbs: Array<string>, path: string, relativePath: string, extension: string } } };
...
export type PostsConnectionQuery = { postsConnection: { totalCount: number, pageInfo: { hasPreviousPage: boolean, hasNextPage: boolean, startCursor: string, endCursor: string }, edges: Array<{ cursor: string, node: { __typename: 'Posts', id: string, title: string, slug: string | null, author: string, pubDatetime: string, modDatetime: string | null, featured: boolean | null, draft: boolean | null, tags: Array<string | null> | null, description: string, ogImage: string | null, canonicalURL: string | null, hideEditPost: boolean | null, timezone: string | null, body: any, _sys: { filename: string, basename: string, hasReferences: boolean | null, breadcrumbs: Array<string>, path: string, relativePath: string, extension: string } } | null } | null> | null } };
